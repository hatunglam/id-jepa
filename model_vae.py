...
from model_2.base_model_graydepth import IDJEPA_base
from utils.types import Number
from model_2.variational_predictor import loss_vae
...
class IDJEPA_VAE(IDJEPA_base, pl.LightningModule):
    def __init__(
        self,
        decoder_depth: int = 6,
        lr: float = 1e-3,
    ...
    def forward(  # pylint: disable=arguments-differ
        ...
        return self.forward_base(
            x_img= x_img,  # (batch_size, channels, img_height, img_width)
            x_dep= x_dep,
    ...
    def update_momentum(self, m: float) -> None:
        ...
        student_model: nn.Module = self.student_encoder.eval()
    ...
    def training_step(  # pylint: disable=arguments-differ
        ...
        (
            prediction,  # prediction: (num_target_blocks, batch_size, target_block_size, embed_dim) 
        ...
        y_student, mu, logvar = prediction
