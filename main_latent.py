...
from latent_idjepa.latent_training import VariationalLatentIDJEPA
from dataset.datamodule import RGBDDataModule
from latent_idjepa.base_latent import CrossAttentionFusion
import gc
import torch
...
if __name__ == "__main__":
    ...
    MODEL_NAME = "variational_latent_idjepa"
    ...
    jepa_model = VariationalLatentIDJEPA(image_encoder=image_encoder,
    ...
    # Callbacks
    checkpoint_callback = ModelCheckpoint(dirpath="./latent_checkpoints",
                                          filename=MODEL_NAME,
