...
from .vit_graydepth import GrayImageDepthTransformer
...
def make_vit_builder(size: str) -> Callable[..., GrayImageDepthTransformer]:
    def builder(
...
vit_model_builders: Dict[str, Callable[..., GrayImageDepthTransformer]] = {
...
#     vit_tiny_builder: Callable[..., RGBDVisionTransformer] = vit_model_builders["tiny"]

#     b_vit_init: RGBDVisionTransformer = save_model_weights(
