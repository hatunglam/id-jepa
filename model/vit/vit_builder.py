...
def make_vit_builder(size: str) -> Callable[..., RGBDVisionTransformer]:
    def builder(
...
vit_model_builders: Dict[str, Callable[..., RGBDVisionTransformer]] = {
